...
const NavLink: FC<NavLinkProps> = ({ href, icon, label }) => {
  ...
  return (
    <Link
      ...
      className={
        isActive
          ? 'border-t-2 lg:border-t-0 lg:text-neon-blue border-neon-blue py-2 lg:py-0 w-full font-semibold'
          : 'py-2 lg:py-0 w-full hover:text-blue-700 hover:font-semibold'
      }>
