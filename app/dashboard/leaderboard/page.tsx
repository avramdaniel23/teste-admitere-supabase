...
export default function Leaderboard() {
  return <div className="flex flex-col gap-4 items-center pb-24 w-full bg-blue-100 lg:py-20">
    {/* <h5 className="w-fit">Leaderboard</h5> */}
    <div className="flex flex-row w-[90%] h-80 lg:h-[32rem] rounded-md md:w-[70%]"> 
      ...
      <div className="justify-end flex flex-col gap-2 w-full h-full">
        ...
        points={789}
        />
        <div className="flex flex-col items-center gap-4 w-full h-[40%] bg-zinc-200 rounded-l-md shadow-lg">
      ...
      <div className="justify-end flex flex-col gap-2 w-full h-full">
        ...
        points={628}
        />
        <div className="flex flex-col items-center gap-4 w-full h-[35%] rounded-r-lg bg-amber-600 shadow-lg">
    ...
    {/* GENERAL */}
    <div className="flex flex-col items-center gap-2 py-4 w-[90%] md:w-[80%]">
